        ...
        constructor(private readonly host: ServerHost, private readonly project: Project, private readonly cancellationToken: HostCancellationToken) {
            ...
            this.resolveModuleName = (moduleName, containingFile, compilerOptions, host) => {
                ...
                if (this.project.getTypingOptions().enableAutoDiscovery && globalCache) {
                    ...
                    if (resolvedName) {
                        return createResolvedModule(resolvedName.resolvedFileName, /*isExternalLibraryImport*/ true, resolvedName.isPackageJson, primaryResult.failedLookupLocations.concat(secondaryLookupFailedLookupLocations));
                    }
                }
